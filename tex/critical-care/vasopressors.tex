...
\begin{summarybox}
	\todo[inline]{Add pressor abbreviations}
\end{summarybox}
...
\todo[inline]{Add table for physiologic effects of receptor stimulation from Vasoactive Drugs in Circulatory Shock, also add pictures/graphs from favorite vasopressor article}
